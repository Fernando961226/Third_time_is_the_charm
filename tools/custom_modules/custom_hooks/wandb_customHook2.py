...
class Custom_MMdetWandbHook2(WandbLoggerHook):
    ...
    def __init__(self,
                 ...
                 bbox_score_thr=0.3,
                 **kwargs):
        super(Custom_MMdetWandbHook2, self).__init__(init_kwargs, interval, **kwargs)
    ...
    def before_run(self, runner):
        super(Custom_MMdetWandbHook2, self).before_run(runner)
    ...
    def after_train_epoch(self, runner):
        super(Custom_MMdetWandbHook2, self).after_train_epoch(runner)
    ...
    def after_train_iter(self, runner):
        if self.get_mode(runner) == 'train':
            ...
            return super(Custom_MMdetWandbHook2, self).after_train_iter(runner)
        else:
            super(Custom_MMdetWandbHook2, self).after_train_iter(runner)
